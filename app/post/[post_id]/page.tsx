...
export default async function ExactPost({ params }: { params: { post_id: string } }) {
    ...
    if (post == null) {
        ...
        return (<div className="grid grid-flow-row bg-zinc-900">
            ...
            <div className="py-3 px-4">
                {(post.image_url != "") && <img className="object-scale-down h-400 w-400 float-right pl-4 pt-2" width={500} height={500} alt="PostPreview" src={post.image_url} />}
